...
export default function Login() {
 ...
 return (
  <div className="h-[calc(100vh-80px)] flex justify-center items-center overflow-hidden  dark:bg-gray-900 px-4">
    <form
    ...
    >
      <h1 className="my-5 text-2xl text-center font-bold text-green-700 dark:text-green-400">Login Now!</h1>

      {errorMsg && (
        <div
          className="p-4 mb-4 text-sm text-red-800 dark:text-red-700 rounded-lg bg-red-50 dark:bg-red-100 text-center"
          role="alert"
        >
          {errorMsg}
        </div>
      ...
      <div>
        ...
        {formikLogin.errors.email && formikLogin.touched.email && (
          <div className="p-2 my-2 text-xs text-red-700 dark:text-red-600 bg-red-100 dark:bg-red-200 rounded text-center">
      ...
      <div className="flex items-center justify-between mt-6">
        ...
        <Link
          to="/reset-password"
          className="hover:underline text-sm font-medium text-gray-700 dark:text-gray-300"
        >
